...
public class AzDevOpsPollingService {
    ...
    @Scheduled(fixedDelayString = "${io.terrakube.vcs.azuredevops.polling.interval:60000}",
            initialDelayString = "${io.terrakube.vcs.azuredevops.polling.initial-delay:30000}")
    public void poll() {
